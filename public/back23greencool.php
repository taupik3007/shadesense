...
<section class="flex w-full mt-5 mx-auto justify-center" >
    <div class="flex w-2/4 flex-row h-16 justify-center  gap-3">
        <div class=" bg-rose-200  w-auto">
            <p class="text-amber-800 w-full text-justify font-serif text-base px-4 py-2">You can find clothes in matching colors with the picture! Click the button below, and you will be directed to the UNIQLO store.</p>
          </div>
          <div class=" w-56  ">
