...
<section class="flex justify-center w-full max-h-screen mx-auto">
  <div class=" block ">
    <img  class=" w-80 h-auto" src="./image/37.jpg" alt="">
  </div>
</section>
<section class="flex justify-center w-full mt-5 mx-auto">
  <div class="block">
    <p class="text-amber-800 w-96 text-center font-serif text-base">Wow! You look beautiful in this dusty pink color! With this, you'll appear more confident!</p>
</div>
</section>
