...
>>>>>>> 3d4cd696a7188ed9aa84a047f556a751a637bc72:public/next16.php
              ...
              <div style="padding-top: 40px;" class="block">
                  ...
                  <p class=" text-rose-900 max-w-xl font-medium font-serif lg:flex text-base mt-5">People with olive undertone have veins that are a combination of blue and green/olive colors. They have a slight greenish-brown color to their skin.
                  </P>
                  <P class=" text-rose-400 max-w-xl font-serif lg:flex font-light mt-5">
                    Orang dengan olive undertone memiliki urat nadi perpaduan warna biru dan hijau/olive. Cirinya kulit sedikit warna coklat kehijauan.</p>
              </div>
          </section>
