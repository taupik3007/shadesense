...
<section class="flex justify-center w-full max-h-screen mx-auto">
  <div class=" block ">
    <img  class="mt-5 w-72 h-auto" src="./image/17.jpg" alt="">
  </div>
</section>
<section class="flex justify-center w-full mt-5 mx-auto">
  <div class="block">
    <p class="text-amber-800 w-72 text-center font-serif text-lg">Your Skintone is a Cool and here you can check the color! </p>
</div>
</section>
