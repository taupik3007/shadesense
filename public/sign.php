...
<body>
  ...
  <!-- section 1 -->
    <section class="flex justify-center w-full max-h-screen mt-5 mx-auto">
      <div class=" block ">
        <img style="width: 340px; height: auto;" class="mt-5 max-h-52" src="./image/shade.jpg" alt="">
      </div>
    </section>
    <section class="flex justify-center w-full max-h-screen mt-5 mx-auto">
      <div class="block">
    ...
    <section class="mt-5 flex justify-center w-full">
      <form action="" class="block w-72 h-auto">
        ...
        <div class="relative block mt-5">
          <button class="bg-rose-300 text-white p-5 h-10 rounded-full w-72 border py-2 pl-9 pr-3 sm:text-sm" type="submit">SIGN UP</button>
        </div>
