...
<nav class="bg-rose-100 ">
    ...
    <section class="flex justify-center w-full  max-h-screen mt-5 mx-auto ">
        <div class="block">
            <p class="max-w-xs w-64 text-center text-amber-800 font-serif  text-sm">This is an application to determine that suit your skin undertone,so the results can be satisfying and boost your confidence in your fashion.</p>
        </div>
    </section>
    <section class="mt-5 flex justify-center w-full ">
     ...
     <section class="mt-5 lg:flex justify-center w-full mb-5 sm:text-left flex ">
        ...
        <div class="font-serif text-amber-800 text-xs">EMAH ROHIMAH ✦</div>
        <div class="font-serif text-amber-800 text-xs">EVA PATIMAH ✦</div>
        <div class="font-serif text-amber-800 text-xs"> ILHAM WAHYU BUDIADJI ✦</div>
        <div class="font-serif text-amber-800 text-xs">NAJWA ZAHRATUL KUBRO </div>
     </section>
